...
def get_model(args):
    ...
    short1_1dto2d = Dense(24 * 24)(inputMLP)
    short1_1dto2d = PReLU()(short1_1dto2d)
    short1_1dto2d = BatchNormalization()(short1_1dto2d)
    short1_1dto2d = Dropout(0.25)(short1_1dto2d)
    short1_1dto2d = Reshape((24, 24, 1))(short1_1dto2d)
    short1_1dto2d = Deconvolution2D(16, 9, 9, output_shape=(None, 40, 30, 16), border_mode='valid')(
        short1_1dto2d)
    short1_1dto2d = PReLU()(short1_1dto2d)
    short1_1dto2d = BatchNormalization()(short1_1dto2d)

    # CNN - post-cross-connections 1
    print(pool.shape, short1_1dto2d.shape)
   ...
   # x21 = cbam_block(x21)
    ...
    # MLP to CNN - cross-connections
    x12 = Dense(13 * 13)(fcMLP)
    x12 = PReLU()(x12)
    x12 = BatchNormalization()(x12)
    x12 = Dropout(0.5)(x12)
    x12 = Reshape((13, 13, 1))(x12)
